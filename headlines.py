...
# Adding default variables so we always have data
...
CURRENCY_URL = "https://openexchangerates.org//api/latest.json?app_id=024c7fe3bcf14390a27c8540a42f1000"
...
def home():
    ...
    #customized currency based on user input or default
